...
std::string BuildSystemPrompt(const Intent& intent,
    ...
    prompt
        ...
        << "Good everyday style is short, relaxed, and alive: 'That's real.', 'Clean.', 'Solid.', 'Smart.', 'No worries.', 'Fair enough.', 'Real talk:', 'Honest answer:', 'Short answer:', 'Yeah, that tracks.', and 'Let's go.' are tone examples, not scripts to repeat. "
