...
std::string BuildSystemPrompt(const Intent& intent,
    ...
    switch (intent.mode) {
        case IntentMode::Social:
            prompt << "Respond naturally, casually, and briefly. Match the user's friendly energy with relaxed warmth and a little wry ease when it fits. Casual mode is for pure small talk, greetings, banter, and light celebration. If the user mentions working hard, building Symbion, tuning responses, response style, or a repeated critique, acknowledge that effort or feedback first before answering casually. Understand slang by context: sick, fire, dope, clean, lit, bet, cookin, and big W usually mean good unless the user clearly means illness or distress. It is okay to simply vibe with good news; do not automatically ask if something is on their mind. Do not explain your design unless the user is directly critiquing response style. Do not use support-bot phrases like 'quiet presence' unless the user is distressed. ";
            break;
